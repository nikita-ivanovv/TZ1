...
3. Команда `chmod +x script.sh` дает права на выполнение скрипта.
4. Запускаем скрипт с помощью команды `bash script.sh НАЗВАНИЕ_ВХОДНОЙ_ДИРЕКТОРИИ НАЗВАНИЕ_ВЫХОДНОЙ_ДИРЕКТОРИИ`, например: bash script.sh input_dir output_dir
